...
export async function fecthResults(searchParams: SearchParams){
                        ...
                        _fns: [
                            {
                                _fn: "xpath_one",
                                _args: [
                                    ".//div[contains(@class, 'abf093bdfe f45d8e4c32')]/div[contains(@class, 'abf093bdfe f45d8e4c32')]/text()",
                                ],
                            },
                        ],
                    },
                        ...
                        _fns:[
                            {
                                _fn : "xpath_one",
                                _args : [
                                    ".//div[@class='abf093bdfe f45d8e4c32']/text()"
                                ]
                            }
                        ]
                    },
