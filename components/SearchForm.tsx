    ...
    return(
        <Form {...form}>
            <form
             ...
             className="flex flex-col lg:flex-row lg:max-w-[1440px] lg:max-auto items-center justify-center space-x-0 lg:space-x-2
             space-y-4 lg:space-y-0 rounded-lg">

                <div className="grid w-full lg:max-w-lg items-center gap-1.5">
                    <FormField
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <FormControl>
                                        ...
                                        name="dates"
                                        variant={"outline"}
                                        className={cn("w-full lg:w-[350px] justify-start text-left font-normal",
