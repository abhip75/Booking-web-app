import { fecthResults } from "@/lib/fetchResults";
...
async function SearchPage({ searchParams } : Props){
    ...
    const results = await fecthResults(searchParams);   
            ...
            <div className="mx-auto max-w-7xl p-6 lg:px-8">
                ...
                <div className="space-y-2 mt-5">
                    {results.content.listings.map((item,i) => (
                        <div key={i}
                         className="flex space-y-2 justify-between space-x-4 p-5
                         border rounded-lg">
                            <img
                              src={item.url}
                              ...
                              <div className="flex flex-1 space-x-5 justify-between">
                                ...
                                <div className="flex flex-col justify-between">
                                    <div className="flex items-start justify-end space-x-2
                                     text-right">
                                        <div>
                                            <p className="text-lg font-semibold">{item.rating_word}</p>
                                        ...
                                        font-bold text-sm w-10 h-10 text-white bg-blue-900
